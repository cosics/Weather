...
function displayResults(weather) {
    ...
    hilow.innerText = `${Math.round(weather.main.temp_min)}°C / ${Main.round(weather.main.temp_max)}°C`;
}

function dateBuilder (d){
    let months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'Octomber', 'November', 'December'];
    let days = ['Sunday', 'Monday', 'Tuedsay', 'Wednesday', 'Thursday', 'Friday', 'Saturday']
